...
def onMouse(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_RBUTTONDOWN:
        ...
        cv2.imwrite("images/cat%d.jpg" % no, warp(img))
...
cascade = 'C:/users/Administrator/Desktop/pythonProject/chap12/haarcascade_frontalcatface.xml'
...
def detectCatFace(no):
    ...
    # 얼굴 검출0
    faces = face_cascade.detectMultiScale(grayImg, SF, N, 0, MS)
    # 검출된 얼굴 개수 출력
